...
## Paper
The full research paper is available here: [Context-Aware Tactical Image Encryption — Achieving 0.0 MSE via Integer Wavelets and Biological DNA Algebra](docs/Context-Aware_Tactical_Image_Encryption_Achieving_0_0_MSE_via_Integer_Wavelets_and_Biological_DNA_Algebra.pdf)
